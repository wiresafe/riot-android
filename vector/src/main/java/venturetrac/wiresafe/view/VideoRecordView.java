...
public class VideoRecordView extends RelativeLayout {
    ...
    private void initView() {
        View.inflate(getContext(), venturetrac.wiresafe.R.layout.video_record_view, this);

        // retrieve the UI items
        mVideoRecordProgressView = (VideoRecordProgressView) findViewById(venturetrac.wiresafe.R.id.video_record_progress_view);
    }
