...
package venturetrac.wiresafe.services;
...
import venturetrac.wiresafe.receiver.DismissNotificationReceiver;
import venturetrac.wiresafe.util.NotificationUtils;
import venturetrac.wiresafe.util.RiotEventDisplay;
...
//        notifBuilder.setSmallIcon(R.drawable.permanent_notification_transparent);
        notifBuilder.setSmallIcon(R.drawable.ic_wiresafe_notification);
